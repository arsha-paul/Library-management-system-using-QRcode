...
(191, 'General Reference', 'Computer', 'Software Engineering', '10', 'fghf@gjgjg', 5, 'Raji Mall', '6hvfgbb', 'GOOD');
...
('1221', 'Yedu v.s', 'Student', 'Student', 'Compstud', 'yedu.india@gmail.com', 8907320444, 'yedu'),
...
--
ALTER TABLE `book`
  MODIFY `BookId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=192;
